 ...
 */
final class Version20210409102140 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE reparations CHANGE user_id user_repair_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE reparations CHANGE user_repair_id user_id INT DEFAULT NULL');
